# Parse accuracy — 2026-08-20T23:55:28.045Z
...
| --- | --- |
| Cases passed | 84.1% |
| Item precision / recall / F1 | 97.7% / 92.4% / 95.0% |
| Portion within band | 95.6% |
| Item calories within band | 91.1% |
...
| Expected calibration error | 0.105 |

## Failure taxonomy

| Code | Count | What it means |
| --- | --- | --- |
| `missed_item` | 8 | a food in the line is absent from the parse |
